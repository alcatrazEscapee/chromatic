package  {
	...
	public class ChromaticWeb extends MovieClip{
				...
				for(i = 0;i<actions.length;i++){
					...
					if(tileActual[actions[i].pos].tile == 1){ // Straight Pipe
						...
						if((tileActual[actions[i].pos].rot == "xN" && actions[i].dir == "W") || (tileActual[actions[i].pos].rot == "xS" && actions[i].dir == "E") || (tileActual[actions[i].pos].rot == "xE" && actions[i].dir == "N") || (tileActual[actions[i].pos].rot == "xW" && actions[i].dir == "S")){
							// All Left Inputs
							if((tileActual[actions[i].pos].colL == "ALL" || tileActual[actions[i].pos].colL == s(actions[i].col)) && actions[i].pre == 1 && tileActual[actions[i].pos].preL == 1){
							...
							// All Mid Inputs
							if((tileActual[actions[i].pos].colM == "ALL" || tileActual[actions[i].pos].colM == s(actions[i].col)) && actions[i].pre == 1 && tileActual[actions[i].pos].preM == 1){
							...
							// All Right Inputs
							if((tileActual[actions[i].pos].colR == "ALL" || tileActual[actions[i].pos].colR == s(actions[i].col)) && actions[i].pre == 1 && tileActual[actions[i].pos].preR == 1){
						...
						if((tileActual[actions[i].pos].rot == "xN" && actions[i].dir == "W") || (tileActual[actions[i].pos].rot == "xS" && actions[i].dir == "E") || (tileActual[actions[i].pos].rot == "xE" && actions[i].dir == "N") || (tileActual[actions[i].pos].rot == "xW" && actions[i].dir == "S")){
							// All Left Inputs
							if((tileActual[actions[i].pos].colL == "ALL" || tileActual[actions[i].pos].colL == s(actions[i].col)) && actions[i].pre == tileActual[actions[i].pos].preL){
								tiles[actions[i].pos].pipe.flow_LIN.col.gotoAndStop(s(actions[i].col));
								tiles[actions[i].pos].pipe.flow_LIN.play();
								tiles[actions[i].pos].pipe.flow_LIN.visible = true;
							...
							// All Mid Inputs
							if((tileActual[actions[i].pos].colM == "ALL" || tileActual[actions[i].pos].colM == s(actions[i].col)) && actions[i].pre == tileActual[actions[i].pos].preM){
								tiles[actions[i].pos].pipe.flow_MIN.play();
								tiles[actions[i].pos].pipe.flow_MIN.col.gotoAndStop(s(actions[i].col));
								tiles[actions[i].pos].pipe.flow_MIN.visible = true;
							...
							// All Right Inputs
							if((tileActual[actions[i].pos].colR == "ALL" || tileActual[actions[i].pos].colR == s(actions[i].col)) && actions[i].pre == tileActual[actions[i].pos].preR){
								tiles[actions[i].pos].pipe.flow_RIN.play();
								tiles[actions[i].pos].pipe.flow_RIN.col.gotoAndStop(s(actions[i].col));
								tiles[actions[i].pos].pipe.flow_RIN.visible = true;
